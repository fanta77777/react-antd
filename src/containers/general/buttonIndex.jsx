...
class Main extends Component {
  ...
  delayLoading = () => {
    ...
    setTimeout(() => this.setState({delayLoading: false}), 150);
  }
  render() {
      ...
      <Row type="flex" justify="space-between" align="top" gutter={16}>
        <Col span={12}>
          <Card title="幽灵按钮" bordered={false}>
            ...
            <Row type="flex" align="top" gutter={16} style={{
                background: 'rgb(190, 200, 200)',
                padding: '26px 16px 16px'
              }}>
              <Col>
                <Button type="primary" ghost="ghost">Primary Ghost</Button>
              </Col>
              <Col>
                <Button ghost="ghost">Default Ghost</Button>
              </Col>
              <Col>
                <Button type="dashed" ghost="ghost">Dashed Ghost</Button>
              </Col>
            </Row>
          </Card>
        </Col>
        ...
        <Col span={12}>
          <Card title="加载中状态" bordered={false}>
            ...
            <Row type="flex" align="top" gutter={16}>
              ...
              <Col>
                <Button type="primary" size="small" loading="loading">Loading</Button>
              </Col>
            </Row>
            <br/>
            <Row type="flex" align="top" gutter={16}>
              ...
              <Col>
                <Button type="primary" loading={this.state.delayLoading} onClick={this.delayLoading}>Won&apos;t show loading</Button>
              </Col>
            </Row>
            <br/>
            <Row type="flex" align="top" gutter={16}>
              <Col><Button shape="circle" loading="loading"/></Col>
              <Col><Button type="primary" shape="circle" loading="loading"/></Col>
            </Row>
          </Card>
        </Col>
        <Col span={12}>
            ...
            <Row type="flex" align="top" gutter={16}>
              ...
              <Col>
                <ButtonGroup>
                  ...
                  <Button disabled="disabled">M</Button>
                  <Button disabled="disabled">R</Button>
                </ButtonGroup>
              </Col>
              <Col>
                <ButtonGroup>
