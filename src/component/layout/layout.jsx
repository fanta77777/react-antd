...
class Main extends Component {
  constructor(props) {
    super(props);
    const collapsed = Config.localItem('COLLAPSED') == 'YES'
      ? true
      : false;
    this.state = {
      collapsed: collapsed,
  ...
  onCollapse = (collapsed) => {
    if (collapsed)
      Config.localItem('COLLAPSED', 'YES');
    else
      Config.localItem('COLLAPSED', 'NO');
    this.setState({
      collapsed,
      mode: collapsed
        ? 'vertical'
  ...
  toggle = (collapsed) => {
    console.log('父组件toggle');
    if (collapsed)
      Config.localItem('COLLAPSED', 'YES');
    else
      Config.localItem('COLLAPSED', 'NO');
      console.log(collapsed,888);
    this.setState({
      collapsed: collapsed,
      mode: collapsed
        ? 'vertical'
